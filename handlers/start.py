...
def handle_start_message(bot: TeleBot, chat_id: int):
    ...
    bot.send_message(chat_id, "Проект 'За любовь' — это движение, которое объединяет людей, стремящихся к осознанным отношениям, личностному росту и вдохновляющему сообществу. Через наши игры, курсы, клубы знакомств и партнерскую программу вы найдете новые возможности для счастья и успеха. Выберите раздел, чтобы узнать больше:", reply_markup=markup)
...
Добро пожаловать в мир 'За любовь'! 🌟 Мы создали уникальную экосистему, чтобы помочь вам строить гармоничные отношения, находить единомышленников и раскрывать свой потенциал. Чтобы мы могли предложить вам самые актуальные мероприятия, игры и возможности в вашем регионе, пожалуйста, укажите ваш город и поделитесь номером телефона, привязанным к Telegram. Это займет всего минуту!""")
